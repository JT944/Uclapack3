#' sports
#'@description simply typing the city name you want to check and your yelp api key, the function will give you all information (address,rate, etc) of 50 sports shop in that city.
#' @author Jiatong Li
#'
#' @title Get information of sports shops from yelp using your own yelp api key
#' @return
#' @export
#' @usage sports(api1="your client id ",api_key1= "your client_secret",i="City,State")
#'
